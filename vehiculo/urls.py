...
from .views import  DetalleVehiculo,ListaDeVehiculos,ActulizarVehiculo,ListaDeVehiculosDesactivados, CrearVehiculo, ListaDeVehiculosSalamanca, ListaDeVehiculosMadrid, ListaDeVehiculosValladolid,ListaDeVehiculosMallorca, ListaDeVehiculosLasPalmas, ListaDeVehiculosZamora,Foto

vehiculo_patterns = ([
    
    path("",ListaDeVehiculos.as_view(), name="flota"),
    path("Desactivados/",ListaDeVehiculosDesactivados.as_view(), name="vehiculos_desactivados"),
