...
class VehiculoForm(forms.ModelForm):
    ...
    class Meta:
        model = Vehiculo
        fields=['activo','ciudad','tipo','placa','marca','modelo','combustible','color','grupo','bastidor','fecha_matricula','itv','image','odo',]
        widgets={
            'activo':forms.CheckboxInput(attrs={'class':'form-control','onclick':'Activar();',}),
...
class VehiculoActualizarForm(forms.ModelForm):
    ...
    class Meta:
        model = Vehiculo
        fields=['activo','ciudad','tipo','marca','modelo','combustible','color','grupo','bastidor','fecha_matricula','itv','image','odo',]
        widgets={
           'activo':forms.CheckboxInput(attrs={'class':'form-control','onclick':'Activar();',}),
            ...
            'itv':forms.DateInput(attrs={'class':'form-control'}),
