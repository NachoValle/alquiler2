...
class Agencia(models.Model):
    ...
    codigo_postal = models.PositiveIntegerField(verbose_name='C.P.')
    ...
    image = models.ImageField(verbose_name='Avatar',upload_to='Ciudades', null=True, blank=True,)
    condiciones = models.TextField(verbose_name='Condiciones contrato', null=True, blank=True,)
